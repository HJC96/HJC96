...
서비스 계층에 절차적으로 쌓인 로직을 도메인 객체의 책임으로 옮기고, 상태와 행위를 함께 표현하는 풍부한 도메인 모델에 관심이 있습니다. 의존성 분리와 테스트 전략도 함께 고민하고 있습니다.

강의나 책으로 감이 잘 오지 않는 개념은 작은 예제를 만들어 직접 돌려보는 편입니다. 그렇게 만든 코드는 [deep-dive](https://github.com/HJC96/deep-dive)에 모아두고 있습니다.
...
<details>
<summary><strong>이력</strong></summary>
